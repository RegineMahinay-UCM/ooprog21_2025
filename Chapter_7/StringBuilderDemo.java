public class StringBuilderDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("(Lenght set to 20 for StringBuilder): The name is " + nameString + "end");
        System.out.println("(Lenght set to 20 for StringBuilder): The address is " + addressString);
            }
}
